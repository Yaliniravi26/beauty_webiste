...
In the GitHub repository, open **Settings > Pages**, select **GitHub Actions** as
the source, and wait for the workflow to finish. The site will be available at:
`https://<your-username>.github.io/<your-repository>/`

The Vite base path is set automatically from the GitHub repository name during
the Actions build, so the existing website layout and behavior remain unchanged.
